...
<!-- ORDER FORM -->
		...
		<div class="order">
			...
			<form name="orderform" method="POST"> <!-- action="send-form.php" -->
				...
				<input type="text" name="name" placeholder="First Name" id="myName"><span class="error"><?php echo $nameErr; ?></span>
				
				<input type="text" name="company" placeholder="Company Name" id="myCompany"><span class="error"><?php echo $companyErr; ?></span>
				
				<input type="text" name="email" placeholder="Virtual Enterprise Email" id="myEmail"><span class="error"><?php echo $emailErr; ?></span>
				
				<input type="text" name="theme" placeholder="Theme" id="myTheme"><span class="error"><?php echo $themeErr; ?></span>
				
				<input type="text" name="package" placeholder="Package" id="myPackage"><span class="error"><?php echo $packageErr; ?></span>
				
				<input type="text" name="payment" placeholder="Payment Plan (Optional)" id="myPayment">
				
				<input type="text" name="accnt" placeholder="Virtual Enterprise Bank Account Number" id="myBank"><span class="error"><?php echo $accountErr; ?></span>
