...
<html lang="en">
    <head>
        <title>YourCompany Mobile App | Customer testimonials and reviews</title>
        <meta charset="utf-8">
    ...
    <body>
        <section class="secondaryPageHeader halfWindowHeight">
            <div class="testimonial-bg parallax">&nbsp;</div>
            <div class="jumbotron">
                <div class="container">
                    <h1 class="hero fade-in-up text-center"><b>Testimonials</b></h1>
                </div>
            </div>
        </section>
        <section id="testimonials-wrapper">
            <div class="container">
                <h3 class="text-center">We couldn't have done it without <strong>you.</strong></h3>
                <div class="col-md-3 testimonial">
                    <img src="css/images/pictures/testimonials/city-sunny-people-street.jpg" alt="Matt" class="profile-pic">
                    <h3 class="text-center">Person 1</h3>
                    <h5 class="text-center">Systems Manager</h5>
                    <hr>
                    <p><i class="fa fa-quote-left" aria-hidden="true"></i> It has been awesome working with YourCompany. Highly recommended tech! <i class="fa fa-quote-right" aria-hidden="true"></i></p>
                </div>
                <div class="col-md-3 testimonial">
                    <img src="css/images/pictures/testimonials/city-sunny-people-street.jpg" alt="Shannon" class="profile-pic">
                    <h3 class="text-center">Person 2</h3>
                    <h5 class="text-center">Proud Customer</h5>
                    <hr>
                    <p><i class="fa fa-quote-left" aria-hidden="true"></i> It has been awesome working with YourCompany. Highly recommended tech! <i class="fa fa-quote-right" aria-hidden="true"></i></p>
                </div>
                <div class="col-md-3 testimonial">
                    <img src="css/images/pictures/testimonials/city-sunny-people-street.jpg" alt="Jared" class="profile-pic">
                    <h3 class="text-center">Person 3</h3>
                    <h5 class="text-center">Local Bar Owner</h5>
                    <hr>
                    <p><i class="fa fa-quote-left" aria-hidden="true"></i> It has been awesome working with YourCompany. Highly recommended tech! <i class="fa fa-quote-right" aria-hidden="true"></i></p>
                </div>
                <div class="col-md-3 testimonial">
                    <img src="css/images/pictures/testimonials/city-sunny-people-street.jpg" alt="Chris" class="profile-pic">
                    <h3 class="text-center">Person 4</h3>
                    <h5 class="text-center">NewsChannel Anchor</h5>
                    <hr>
                    <p><i class="fa fa-quote-left" aria-hidden="true"></i> YourCompany is helping transform Cleveland into a Smart City and is being hailed as the ‘ultimate visitors guide’. <i class="fa fa-quote-right" aria-hidden="true"></i></p>
                </div>
            </div>
        </section>
