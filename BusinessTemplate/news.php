...
<html lang="en">
    <head>
        <title>YourCompany Mobile App | News and information</title>
        <meta charset="utf-8">
    ...
    <body>
        <section class="secondaryPageHeader halfWindowHeight">
            <div class="news-bg parallax">&nbsp;</div>
            <div class="jumbotron">
                <div class="container">
                    <h1 class="hero fade-in-up text-center"><b>In the news</b></h1>
                </div>
            </div>
        </section>
        <section id="news-wrapper">
            <div class="container">
                <h3 class="text-center">Get in touch with the latest stories</h3>
                <a href="http://www.clevescene.com" class="col-md-4 col-sm-12 col-xs-12 news-story story1">
                    <h1 class="text-right"><b>News Story 1</b></h1>
                    <h4 class="text-right">Cleveland Scene</h4>
                </a>
                <a href="http://www.newsnet5.com" class="col-md-4 col-sm-12 col-xs-12 news-story story2">
                    <h1 class="text-right"><b>News Story 2</b></h1>
                    <h4 class="text-right">newsnet5</h4>
                </a>
                <a href="http://www.cleveland.com" class="col-md-4 col-sm-12 col-xs-12 news-story story3">
                    <h1 class="text-right"><b>News Story 3</b></h1>
                    <h4 class="text-right">Cleveland</h4>
                </a>
            </div>
        </section>
